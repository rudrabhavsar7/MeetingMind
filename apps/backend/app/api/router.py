...
from app.api.v1.pipeline_events import router as pipeline_events_router
...
api_router.include_router(pipeline_events_router, prefix="/workspaces/{workspace_id}/meetings", tags=["pipeline-events"])
api_router.include_router(rag_router, prefix="/workspaces/{workspace_id}/rag", tags=["rag"])
